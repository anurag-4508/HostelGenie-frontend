...
function Suggestions() {
  const getSuggestions = async () => {
    ...
    const response = await fetch("https://hostelgenie.onrender.com/api/suggestion/hostel", {
      method: "POST",
      headers: {
  ...
  const updateSuggestion = async (id) => {
    setLoader(true);
    console.log(id);
    const response = await fetch("https://hostelgenie.onrender.com/api/suggestion/update", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
