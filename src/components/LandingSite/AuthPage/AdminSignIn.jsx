...
export default function AdminSignIn() {
  ...
  const getHostel = async () => {
    ...
    try {
      const res = await fetch("https://hostelgenie.onrender.com/api/admin/get-hostel", {
        method: "POST",
        headers: {
  ...
  let login = async (event) => {
    ...
    let response = await fetch("https://hostelgenie.onrender.com/api/auth/login", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
    ...
    if (result.success) {
      ...
      let admin = await fetch("https://hostelgenie.onrender.com/api/admin/get-admin", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
